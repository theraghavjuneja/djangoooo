...
def home(request):
    ...
    q=request.GET.get('q') if request.GET.get('q')!=None else '' # this will get the query such as which room Javascript Pytho 
...
def room(request,pk):
    ...
    room_messages=room.message_set.all() #Removed .orderby('created' ) instead added class Meta in msg object
